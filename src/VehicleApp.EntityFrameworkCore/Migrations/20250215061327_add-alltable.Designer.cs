...
namespace VehicleApp.EntityFrameworkCore.Migrations
{
    ...
    [Migration("20250215061327_add-alltable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IdentityRoleOrganizationMemberEntity", b =>
                {
                    b.Property<Guid>("OrganizationMemberEntityId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("RolesId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("OrganizationMemberEntityId", "RolesId");
            ...
            modelBuilder.Entity("VehicleApp.Domain.Order.OrderAggregateRoot", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("VehicleApp.Domain.Order.OrderDetailEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("VehicleApp.Domain.Organization.OrganizationAggregateRoot", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("VehicleApp.Domain.Organization.OrganizationMemberEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("VehicleApp.Domain.Store.StoreAggregateRoot", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("VehicleApp.Domain.Vehicle.AccidentRecordEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("VehicleApp.Domain.Vehicle.MaintenanceRecordEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("IdentityRoleOrganizationMemberEntity", b =>
                {
                    b.HasOne("VehicleApp.Domain.Organization.OrganizationMemberEntity", null)
                        .WithMany()
                        .HasForeignKey("OrganizationMemberEntityId")
            ...
            modelBuilder.Entity("VehicleApp.Domain.Order.OrderDetailEntity", b =>
                {
                    b.HasOne("VehicleApp.Domain.Order.OrderAggregateRoot", "Order")
                        .WithMany()
            ...
            modelBuilder.Entity("VehicleApp.Domain.Organization.OrganizationAggregateRoot", b =>
                {
                    b.HasOne("VehicleApp.Domain.Organization.OrganizationAggregateRoot", null)
                        .WithMany("Children")
                        .HasForeignKey("ParentId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.OwnsOne("VehicleApp.Domain.Organization.ContactInfoValueObject", "Contact", b1 =>
                        {
                            b1.Property<Guid>("OrganizationAggregateRootId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.HasKey("OrganizationAggregateRootId");

                            b1.ToTable("Organizations");

                            b1.WithOwner()
                                .HasForeignKey("OrganizationAggregateRootId");
                        });
            ...
            modelBuilder.Entity("VehicleApp.Domain.Store.StoreAggregateRoot", b =>
                {
                    b.OwnsOne("VehicleApp.Domain.Store.GeoLocationValueObject", "Location", b1 =>
                        {
            ...
            modelBuilder.Entity("VehicleApp.Domain.Vehicle.MaintenanceRecordEntity", b =>
                {
                    b.HasOne("VehicleApp.Domain.Vehicle.VehicleAggregateRoot", "Vehicle")
